...
use bytetex_core::warnings::{Category, Range, Severity, Warning};
...
fn warning_serializes_with_expected_shape() {
    let w = Warning {
        ...
        suggested_skill: Some("bytetex-tikz-to-typst".into()),
    };
    ...
    assert_eq!(json["suggested_skill"], "bytetex-tikz-to-typst");
}
