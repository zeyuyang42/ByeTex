//! MCP smoke test: spawn `bytetex serve`, perform the standard `initialize`
...
fn mcp_server_handshakes_and_lists_tools() {
    ...
    assert!(content.contains("bytetex-using-warnings-json"));
